...
```bash
root@serverd:/home/pp/net63# docker exec nt_mysql /usr/bin/mysql -u root --password=mysql -e 'CREATE DATABASE test_db'
mysql: [Warning] Using a password on the command line interface can be insecure.
root@serverd:/home/pp/net63# docker cp test_dump.sql  nt_mysql:/etc/mysql
root@serverd:/home/pp/net63# docker exec -it nt_mysql bash
...
```
память
root@serverd:/home/pp/net63# docker ps -q | xargs  docker stats --no-stream
